...
Rather than requiring the user to type "d" to remove a brushed region, he can just select a new region directly, and the old region will automatically be removed.